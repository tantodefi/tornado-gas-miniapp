// lib/storage/indexed-db-storage.ts
...
// Enhanced card interface for IndexedDB
export interface PoolCard {
  ...
  identity: {
    mnemonic: string; // BIP39 12-word mnemonic
    privateKey: string; // Derived from mnemonic
    commitment: string; // Semaphore identity commitment
  };
  paymasterContract: string;
  createdAt: string;
  status: "pending-topup" | "active";
