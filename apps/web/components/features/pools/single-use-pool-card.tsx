//file: prepaid-gas-website/apps/web/components/features/pools/single-use-pool-card.tsx
"use client";
...
const SingleUsePoolCard: React.FC<{
  ...
  const joiningFee = isDummy ? "0.0001" : formatJoiningFee(pool.joiningFee);
  const memberCount = isDummy ? "423" : formatMembersCount(pool.memberCount);
