//file: prepaid-gas-website/apps/web/components/shared/cache-enabled-pool-card.tsx
"use client";
...
const CacheEnabledPoolCard: React.FC<{
  pool?: Pool;
  ...
  return (
    ...
    >
      ...
      >
        <motion.div
          className="w-full h-full bg-gradient-to-br from-green-600 to-emerald-800 rounded-xl relative overflow-hidden"
          animate={{
            rotateY: [0, 2, 0, -2, 0],
            rotateX: [0, 1, 0, -1, 0],
          }}
          ...
          <div className="p-4 sm:p-5 lg:p-6 h-full flex flex-col justify-between">
            <div className="flex justify-between items-start">
              <div className="flex flex-col items-start ">
                ...
                <div className="text-xs text-green-300">GAS CREDITS</div>
              </div>
...
export default CacheEnabledPoolCard;