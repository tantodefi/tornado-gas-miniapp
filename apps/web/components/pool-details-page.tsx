...
import { type PaymentPool } from "@/components/payment";

// Import extracted components
import EnhancedPoolCard from "./pool-details/enhanced-pool-card";
import PoolOverview from "./pool-details/pool-overview";
import TechnicalDetailsSection from "./pool-details/technical-details-section";
import MembersSection from "./pool-details/members-section";
import PoolActivitySection from "./pool-details/pool-activity-section";
import PaymentModal from "./pool-details/payment-modal";
import SecureSuccessScreen from "./pool-details/secure-success-screen";
import LoadingSkeleton from "./pool-details/loading-skeleton";
import ErrorState from "./pool-details/error-state";
